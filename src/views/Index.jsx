...
import {
  Container, Row, Col, Card, CardBody, CardImg, CardTitle, Button
} from 'reactstrap'
        ...
        <div className="landing">
          <div className="banner section">
            <Container>
              ...
              <Countdown date={moment('20191031').local().format()} renderer={customCountdown}>
              ...
              <Col md={4}>
                <Card>
                  ...
                  <CardBody>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit mus massa condimentum dignissim vitae, class interdum aptent ultrices turpis sodales malesuada ad mattis fames tellus, luctus aliquet euismod enim varius cubilia iaculis nulla platea non habitasse.</p>
                    <Button href="/gastronomia/" color="primary" size="sm" block>Conocer más</Button>
                  </CardBody>
                </Card>
              </Col>
              <Col md={4}>
                <Card>
                  ...
                  <CardBody>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit mus massa condimentum dignissim vitae, class interdum aptent ultrices turpis sodales malesuada ad mattis fames tellus, luctus aliquet euismod enim varius cubilia iaculis nulla platea non habitasse.</p>
                    <Button href="/tradiciones/" color="primary" size="sm" block>Conocer más</Button>
                  </CardBody>
                </Card>
              </Col>
              <Col md={4}>
                <Card>
                  ...
                  <CardBody>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit mus massa condimentum dignissim vitae, class interdum aptent ultrices turpis sodales malesuada ad mattis fames tellus, luctus aliquet euismod enim varius cubilia iaculis nulla platea non habitasse.</p>
                    <Button href="/musica-danza/" color="primary" size="sm" block>Conocer más</Button>
                  </CardBody>
                </Card>
              </Col>
            </Row>
                ...
                return (
                  <Col md={6} key={place.name}>
                    <Card>
                      <Row>
                        <Col md={6}>
                          <CardImg src={place.image} alt={`${place.name}, ${place.state}`} />
                        </Col>
                        <Col md={6}>
                          <CardBody>

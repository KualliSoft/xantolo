...
function App() {
  ...
  console.log(moment("20201031").local());
  return (
    <div className="App">
      <h1>Xantolo</h1>
      <p>vivos y muertos estaremos de fiesta en...</p>
      <Countdown date={moment("20201031").local()} renderer={customCountdown}>
        <div>Xantolo ha comenzado!</div>
      </Countdown>
      <footer>
        <p>
          Queremos dar a conocer más información y los eventos que se llevarán
          acabo en Xantolo en la región Huasteca.
        </p>
        creado con amor por{" "}
        <a
          rel="noopener noreferrer"
          href="https://www.facebook.com/KualliSoft"
          target="_blank"
        >
          KualliSoft
        </a>
